...
namespace Ordering.Application.Feature.Orders.Commands.CheckoutOrder
{
    public class CheckoutOrderCommandHandler : IRequestHandler<CheckoutOrderCommand, int>
    {
        ...
        {
            var email = new Email() { To = "cjaytech@gmail.com", Body = $"Order was created.", Subject = "Order was created" };
